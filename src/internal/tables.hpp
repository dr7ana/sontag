...
namespace sontag::tables {
    ...
    inline const std::flat_map<std::string, std::string> X86{
            ...
            {"FCOM", "FP Compare Real"},
            {"FCOM2", "FP Compare Real"},
            ...
            {"FIDIV", "FP Divide by Int"},
            {"FIDIVR", "Reverse FP Divide by Int"},
            {"FILD", "Load Integer to FP Register"},
            {"FIMUL", "Load Integer to FP Register, Multiply"},
            {"FINCSTP", "Increment Stack-Top Pointer"},
            {"FINIT", "Initialize Floating-Point Unit"},
            {"FIST", "Store Integer to FP Register"},
            {"FISTP", "Store Integer to FP Register and Pop"},
            {"FISTTP", "Store Integer with Truncation and Pop"},
            {"FISUB", "Store Integer to FP Register and Subtract"},
